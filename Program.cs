...
namespace Thomas_Assign2
{
    ...
    public class Student : IComparable
    {
        ...
        private Acadyear acdyear;
        private float gpa;
        private ushort crhours;
    ...
    public class Course : IComparable
    {
        ...
        private uint cnum;
        private String deptcode, section;
        private ushort chours, max_enrollment, stu_enrolled_count;
        private List<int> stu_enrolled = new List<int>();     //list to store all the zids of newly enrolling students
        ...
        public String Deptcode
        {
            ...
            {
                int ch = 0;
                if (value.Length >= 3)                          //department code should have 4 characters.
                {
    ...
    public class Program      //was static class Program initially! can i change it?
    {
        /// <summary>
        ...
        static void Main()
        {
            ...
            if (File.Exists(Path + "\\2188_a2_input01.txt"))
            {
                if (File.Exists(Path + "\\2188_a2_input02.txt"))
                {
                    using (StreamReader SR = new StreamReader(Path + "\\2188_a2_input01.txt"))        //reading the contents of Student input file.
                    {
                        int index = 0;
                        Char delimiter = ',';
                        ...
                        while (S != null)                   //parsing the file until end of file is reached.
                        {
                            ...
                            students.LName = sub[1];
                            students.FName = sub[2];
                    ...
                    using (StreamReader SR = new StreamReader(Path + "\\2188_a2_input02.txt"))        ////reading the contents of Course input file.
                    {
                        int index = 0;
                        Char delimiter = ',';
